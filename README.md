...
└──────────────────▲────────────────────────────────▲─────────────────┘
        ...
        │ replay + parser     │         │ OpenCV + YOLOv8n CPU │
...
**Streamlit mode (recommended for Streamlit Cloud):**
...
├── dashboard/                    # Streamlit app + FastAPI local dashboard
...
| Layer 5 dashboard               | `dashboard/app.py` (Streamlit) + `dashboard/fastapi_app.py` (local FastAPI) |
