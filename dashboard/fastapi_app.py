"""
dashboard/fastapi_app.py - FastAPI monitoring layer for local uvicorn runs.

Streamlit Cloud uses dashboard/app.py. This module keeps the original FastAPI
entrypoint available for run_local.py and scripts/run_all.sh.
...
Run with:
  uvicorn dashboard.fastapi_app:app --host 0.0.0.0 --port 8080 --reload
"""
